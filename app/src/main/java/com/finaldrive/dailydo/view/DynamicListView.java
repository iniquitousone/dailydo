...
public class DynamicListView extends ListView {
    ...
    private BitmapDrawable getAndAddHoverView(View v) {
        ...
        Bitmap b = getBitmapWithOverlay(v);
    ...
    /**
     * Draws a thin border over the screen-shot of the view passed in.
     */
    ...
    /**
     * Draws an overlay over the screen-shot of the view passed in.
     */
    private Bitmap getBitmapWithOverlay(View v) {
        Bitmap bitmap = getBitmapFromView(v);
        Canvas can = new Canvas(bitmap);
    ...
    /**
     * Returns a bitmap showing a screen-shot of the view passed in.
     */
    ...
    /**
     * Swaps the position of two items in the List and notifies the Adapter that the database is out of sync.
     *
     * @param list
     * @param indexOne
     * @param indexTwo
     */
    private void swapElements(List<Task> list, int indexOne, int indexTwo) {
        Task temp = list.get(indexOne);
        list.get(indexOne).setRowNumber(indexTwo);
